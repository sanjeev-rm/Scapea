...
let SAMPLE_MY_PLANTS = [
    ...
    MyPlant(image: Image(.plant3), name: "Parnika", plantType: "Aloe vera", moisture: 80, ph: 6.4, needsWater: false),
    MyPlant(image: Image(.plant4), name: "Sylvie", plantType: "Bougainvillea", moisture: 90, ph: 6.4, needsWater: false)
]
